...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.houseHold.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.house-holds.store") }}" enctype="multipart/form-data">
            @csrf
...
>>>>>>> quickadminpanel_2020_06_28_07_35_51
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('relative_first_name') ? 'is-invalid' : '' }}" type="text" name="relative_first_name" id="relative_first_name" value="{{ old('relative_first_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('relative_last_name') ? 'is-invalid' : '' }}" type="text" name="relative_last_name" id="relative_last_name" value="{{ old('relative_last_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('percentage_charged') ? 'is-invalid' : '' }}" type="number" name="percentage_charged" id="percentage_charged" value="{{ old('percentage_charged', '') }}" step="0.01">
