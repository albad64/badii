    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.holidays.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('holidays_type') ? 'is-invalid' : '' }}" name="holidays_type" id="holidays_type" required>
                    ...
                    @foreach(App\Holiday::HOLIDAYS_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('holidays_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday_year') ? 'is-invalid' : '' }}" type="number" name="holiday_year" id="holiday_year" value="{{ old('holiday_year', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday_month') ? 'is-invalid' : '' }}" type="number" name="holiday_month" id="holiday_month" value="{{ old('holiday_month', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday_residual') ? 'is-invalid' : '' }}" type="number" name="holiday_residual" id="holiday_residual" value="{{ old('holiday_residual', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday_actual') ? 'is-invalid' : '' }}" type="number" name="holiday_actual" id="holiday_actual" value="{{ old('holiday_actual', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('holiday_enjoyed') ? 'is-invalid' : '' }}" type="number" name="holiday_enjoyed" id="holiday_enjoyed" value="{{ old('holiday_enjoyed', '') }}" step="0.01">
