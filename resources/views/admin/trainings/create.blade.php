    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trainings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_supplier') ? 'is-invalid' : '' }}" type="text" name="training_supplier" id="training_supplier" value="{{ old('training_supplier', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_location') ? 'is-invalid' : '' }}" type="text" name="training_location" id="training_location" value="{{ old('training_location', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_description') ? 'is-invalid' : '' }}" type="text" name="training_description" id="training_description" value="{{ old('training_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_year') ? 'is-invalid' : '' }}" type="number" name="training_year" id="training_year" value="{{ old('training_year', '') }}" step="1">
