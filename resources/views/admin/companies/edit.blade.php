    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies.update", [$company->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company') ? 'is-invalid' : '' }}" type="text" name="company" id="company" value="{{ old('company', $company->company) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('currency') ? 'is-invalid' : '' }}" name="currency_id" id="currency_id" required>
                    @foreach($currencies as $id => $currency)
                        <option value="{{ $id }}" {{ ($company->currency ? $company->currency->id : old('currency_id')) == $id ? 'selected' : '' }}>{{ $currency }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('invoice_prefix') ? 'is-invalid' : '' }}" type="text" name="invoice_prefix" id="invoice_prefix" value="{{ old('invoice_prefix', $company->invoice_prefix) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_prefix') ? 'is-invalid' : '' }}" type="text" name="project_prefix" id="project_prefix" value="{{ old('project_prefix', $company->project_prefix) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('legal_working_hours') ? 'is-invalid' : '' }}" type="number" name="legal_working_hours" id="legal_working_hours" value="{{ old('legal_working_hours', $company->legal_working_hours) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_instalments') ? 'is-invalid' : '' }}" type="number" name="monthly_instalments" id="monthly_instalments" value="{{ old('monthly_instalments', $company->monthly_instalments) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('suite') ? 'is-invalid' : '' }}" type="text" name="suite" id="suite" value="{{ old('suite', $company->suite) }}">
                @if($errors->has('suite'))
