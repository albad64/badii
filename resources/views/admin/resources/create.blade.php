    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.resources.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resource_code') ? 'is-invalid' : '' }}" type="text" name="resource_code" id="resource_code" value="{{ old('resource_code', '') }}" required>
...
<<<<<<< HEAD
                ...
                <input class="form-control date {{ $errors->has('hired_date') ? 'is-invalid' : '' }}" type="text" name="hired_date" id="hired_date" value="{{ old('hired_date') }}" required>
=======
                <label for="hired_date">{{ trans('cruds.resource.fields.hired_date') }}</label>
                <input class="form-control date {{ $errors->has('hired_date') ? 'is-invalid' : '' }}" type="text" name="hired_date" id="hired_date" value="{{ old('hired_date') }}">
>>>>>>> quickadminpanel_2020_06_28_07_35_51
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('termination_date') ? 'is-invalid' : '' }}" type="text" name="termination_date" id="termination_date" value="{{ old('termination_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('birth_city') ? 'is-invalid' : '' }}" type="text" name="birth_city" id="birth_city" value="{{ old('birth_city', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('birth_country') ? 'is-invalid' : '' }}" name="birth_country_id" id="birth_country_id">
                    @foreach($birth_countries as $id => $birth_country)
                        <option value="{{ $id }}" {{ old('birth_country_id') == $id ? 'selected' : '' }}>{{ $birth_country }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fiscal_code') ? 'is-invalid' : '' }}" type="text" name="fiscal_code" id="fiscal_code" value="{{ old('fiscal_code', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('company_partner') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="company_partner" id="company_partner" value="1" {{ old('company_partner', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('protected_categories') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="protected_categories" id="protected_categories" value="1" {{ old('protected_categories', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('disability_percentage') ? 'is-invalid' : '' }}" type="number" name="disability_percentage" id="disability_percentage" value="{{ old('disability_percentage', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ice_person') ? 'is-invalid' : '' }}" type="text" name="ice_person" id="ice_person" value="{{ old('ice_person', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ice_phone') ? 'is-invalid' : '' }}" type="text" name="ice_phone" id="ice_phone" value="{{ old('ice_phone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ice_email') ? 'is-invalid' : '' }}" type="email" name="ice_email" id="ice_email" value="{{ old('ice_email') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_street') ? 'is-invalid' : '' }}" type="text" name="address_street" id="address_street" value="{{ old('address_street', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_city') ? 'is-invalid' : '' }}" type="text" name="address_city" id="address_city" value="{{ old('address_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address_postalcode') ? 'is-invalid' : '' }}" type="text" name="address_postalcode" id="address_postalcode" value="{{ old('address_postalcode', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('address_country') ? 'is-invalid' : '' }}" name="address_country_id" id="address_country_id">
                    @foreach($address_countries as $id => $address_country)
                        <option value="{{ $id }}" {{ old('address_country_id') == $id ? 'selected' : '' }}>{{ $address_country }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('address_state') ? 'is-invalid' : '' }}" name="address_state" id="address_state">
                    ...
                    @foreach(App\Resource::ADDRESS_STATE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('address_state', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('home_email') ? 'is-invalid' : '' }}" type="text" name="home_email" id="home_email" value="{{ old('home_email', '') }}">
...
=======
                ...
                <input class="form-control {{ $errors->has('work_email') ? 'is-invalid' : '' }}" type="email" name="work_email" id="work_email" value="{{ old('work_email') }}">
>>>>>>> quickadminpanel_2020_06_28_07_35_51
...
<<<<<<< HEAD
                ...
                <input class="form-control {{ $errors->has('alt_address_street') ? 'is-invalid' : '' }}" type="text" name="alt_address_street" id="alt_address_street" value="{{ old('alt_address_street', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alt_address_city') ? 'is-invalid' : '' }}" type="text" name="alt_address_city" id="alt_address_city" value="{{ old('alt_address_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alt_address_postalcode') ? 'is-invalid' : '' }}" type="text" name="alt_address_postalcode" id="alt_address_postalcode" value="{{ old('alt_address_postalcode', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('alt_address_country') ? 'is-invalid' : '' }}" name="alt_address_country_id" id="alt_address_country_id">
                    @foreach($alt_address_countries as $id => $alt_address_country)
                        <option value="{{ $id }}" {{ old('alt_address_country_id') == $id ? 'selected' : '' }}>{{ $alt_address_country }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alt_address_state') ? 'is-invalid' : '' }}" type="text" name="alt_address_state" id="alt_address_state" value="{{ old('alt_address_state', '') }}">
