    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.currencies.update", [$currency->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $currency->description) }}" required>
...
>>>>>>> quickadminpanel_2020_06_28_07_35_51
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('decimal_digits') ? 'is-invalid' : '' }}" type="number" name="decimal_digits" id="decimal_digits" value="{{ old('decimal_digits', $currency->decimal_digits) }}" step="1">
