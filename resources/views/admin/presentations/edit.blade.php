...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.presentation.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.presentations.update", [$presentation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('resource_code') ? 'is-invalid' : '' }}" name="resource_code_id" id="resource_code_id" required>
                    @foreach($resource_codes as $id => $resource_code)
                        <option value="{{ $id }}" {{ ($presentation->resource_code ? $presentation->resource_code->id : old('resource_code_id')) == $id ? 'selected' : '' }}>{{ $resource_code }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_number') ? 'is-invalid' : '' }}" type="number" name="order_number" id="order_number" value="{{ old('order_number', $presentation->order_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_host') ? 'is-invalid' : '' }}" type="text" name="event_host" id="event_host" value="{{ old('event_host', $presentation->event_host) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_name') ? 'is-invalid' : '' }}" type="text" name="event_name" id="event_name" value="{{ old('event_name', $presentation->event_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_location') ? 'is-invalid' : '' }}" type="text" name="event_location" id="event_location" value="{{ old('event_location', $presentation->event_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event_year') ? 'is-invalid' : '' }}" type="number" name="event_year" id="event_year" value="{{ old('event_year', $presentation->event_year) }}" step="1">
