    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.education.update", [$education->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_number') ? 'is-invalid' : '' }}" type="number" name="order_number" id="order_number" value="{{ old('order_number', $education->order_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('graduated_year') ? 'is-invalid' : '' }}" type="number" name="graduated_year" id="graduated_year" value="{{ old('graduated_year', $education->graduated_year) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('education_level') ? 'is-invalid' : '' }}" name="education_level" id="education_level" required>
                    ...
                    @foreach(App\Education::EDUCATION_LEVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('education_level', $education->education_level) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('education_area') ? 'is-invalid' : '' }}" type="text" name="education_area" id="education_area" value="{{ old('education_area', $education->education_area) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('education_location') ? 'is-invalid' : '' }}" type="text" name="education_location" id="education_location" value="{{ old('education_location', $education->education_location) }}">
