...
>>>>>>> quickadminpanel_2020_06_28_07_35_51
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('remote_job') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="remote_job" id="remote_job" value="1" {{ old('remote_job', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('work_country') ? 'is-invalid' : '' }}" name="work_country_id" id="work_country_id">
                    @foreach($work_countries as $id => $work_country)
                        <option value="{{ $id }}" {{ old('work_country_id') == $id ? 'selected' : '' }}>{{ $work_country }}</option>
                    @endforeach
                </select>
...
>>>>>>> quickadminpanel_2020_06_28_07_35_51
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('internal_department') ? 'is-invalid' : '' }}" name="internal_department" id="internal_department">
                    ...
                    @foreach(App\Salary::INTERNAL_DEPARTMENT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('internal_department', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('internal_office') ? 'is-invalid' : '' }}" name="internal_office" id="internal_office">
                    ...
                    @foreach(App\Salary::INTERNAL_OFFICE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('internal_office', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('annual_base_salary') ? 'is-invalid' : '' }}" type="number" name="annual_base_salary" id="annual_base_salary" value="{{ old('annual_base_salary', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vat_daily_fee') ? 'is-invalid' : '' }}" type="number" name="vat_daily_fee" id="vat_daily_fee" value="{{ old('vat_daily_fee', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vat_daily_cost') ? 'is-invalid' : '' }}" type="number" name="vat_daily_cost" id="vat_daily_cost" value="{{ old('vat_daily_cost', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('staffing_agency_amount') ? 'is-invalid' : '' }}" type="number" name="staffing_agency_amount" id="staffing_agency_amount" value="{{ old('staffing_agency_amount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('staffing_agency_end_date') ? 'is-invalid' : '' }}" type="text" name="staffing_agency_end_date" id="staffing_agency_end_date" value="{{ old('staffing_agency_end_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reimb_km') ? 'is-invalid' : '' }}" type="number" name="reimb_km" id="reimb_km" value="{{ old('reimb_km', '') }}" step="0.00001">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('nca') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="nca" id="nca" value="1" {{ old('nca', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('nca_end_date') ? 'is-invalid' : '' }}" type="text" name="nca_end_date" id="nca_end_date" value="{{ old('nca_end_date') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('nca_frequency') ? 'is-invalid' : '' }}" name="nca_frequency" id="nca_frequency">
                    ...
                    @foreach(App\Salary::NCA_FREQUENCY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('nca_frequency', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nca_value') ? 'is-invalid' : '' }}" type="number" name="nca_value" id="nca_value" value="{{ old('nca_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('expected_next_lsb_date') ? 'is-invalid' : '' }}" type="text" name="expected_next_lsb_date" id="expected_next_lsb_date" value="{{ old('expected_next_lsb_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_lsb') ? 'is-invalid' : '' }}" type="number" name="monthly_lsb" id="monthly_lsb" value="{{ old('monthly_lsb', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('variable_comp_target') ? 'is-invalid' : '' }}" name="variable_comp_target" id="variable_comp_target">
                    ...
                    @foreach(App\Salary::VARIABLE_COMP_TARGET_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('variable_comp_target', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variable_comp_value') ? 'is-invalid' : '' }}" type="number" name="variable_comp_value" id="variable_comp_value" value="{{ old('variable_comp_value', '') }}" step="0.01">
