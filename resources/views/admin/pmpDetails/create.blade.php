...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pmpDetail.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pmp-details.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('pmp') ? 'is-invalid' : '' }}" name="pmp_id" id="pmp_id">
                    @foreach($pmps as $id => $pmp)
                        <option value="{{ $id }}" {{ old('pmp_id') == $id ? 'selected' : '' }}>{{ $pmp }}</option>
                    @endforeach
                </select>
                @if($errors->has('pmp'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_detail') ? 'is-invalid' : '' }}" type="number" name="number_detail" id="number_detail" value="{{ old('number_detail', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('sub_objective_detail') ? 'is-invalid' : '' }}" name="sub_objective_detail" id="sub_objective_detail">{!! old('sub_objective_detail') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kpi_description') ? 'is-invalid' : '' }}" type="text" name="kpi_description" id="kpi_description" value="{{ old('kpi_description', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mid_year_evaluation') ? 'is-invalid' : '' }}" type="number" name="mid_year_evaluation" id="mid_year_evaluation" value="{{ old('mid_year_evaluation', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mid_year_weight') ? 'is-invalid' : '' }}" type="number" name="mid_year_weight" id="mid_year_weight" value="{{ old('mid_year_weight', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mid_year_notes') ? 'is-invalid' : '' }}" type="text" name="mid_year_notes" id="mid_year_notes" value="{{ old('mid_year_notes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_year_evaluation') ? 'is-invalid' : '' }}" type="number" name="end_year_evaluation" id="end_year_evaluation" value="{{ old('end_year_evaluation', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_year_weight') ? 'is-invalid' : '' }}" type="number" name="end_year_weight" id="end_year_weight" value="{{ old('end_year_weight', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_year_notes') ? 'is-invalid' : '' }}" type="text" name="end_year_notes" id="end_year_notes" value="{{ old('end_year_notes', '') }}">
