    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies-holidays.update", [$companiesHoliday->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seniority') ? 'is-invalid' : '' }}" type="number" name="seniority" id="seniority" value="{{ old('seniority', $companiesHoliday->seniority) }}" step="1">
