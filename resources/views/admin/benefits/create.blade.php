...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.benefits.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.benefit.fields.benefit_extra_type') }}</label>
                <select class="form-control {{ $errors->has('benefit_extra_type') ? 'is-invalid' : '' }}" name="benefit_extra_type" id="benefit_extra_type" required>
                    ...
                    @foreach(App\Benefit::BENEFIT_EXTRA_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('benefit_extra_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.benefit.fields.benefit_type') }}</label>
                <select class="form-control {{ $errors->has('benefit_type') ? 'is-invalid' : '' }}" name="benefit_type" id="benefit_type" required>
                    ...
                    @foreach(App\Benefit::BENEFIT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('benefit_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('assigned_date') ? 'is-invalid' : '' }}" type="text" name="assigned_date" id="assigned_date" value="{{ old('assigned_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('optional_value') ? 'is-invalid' : '' }}" type="number" name="optional_value" id="optional_value" value="{{ old('optional_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fringe_benefit') ? 'is-invalid' : '' }}" type="number" name="fringe_benefit" id="fringe_benefit" value="{{ old('fringe_benefit', '') }}" step="0.01">
