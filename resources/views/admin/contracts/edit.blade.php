        ...
        <form method="POST" action="{{ route("admin.contracts.update", [$contract->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hr_canteen_charge') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="hr_canteen_charge" id="hr_canteen_charge" value="1" {{ $contract->hr_canteen_charge || old('hr_canteen_charge', 0) === 1 ? 'checked' : '' }} required>
