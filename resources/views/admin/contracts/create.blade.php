...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contracts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="company_id">{{ trans('cruds.contract.fields.company') }}</label>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.contract.fields.head_office') }}</label>
                <select class="form-control {{ $errors->has('head_office') ? 'is-invalid' : '' }}" name="head_office" id="head_office" required>
                    ...
                    @foreach(App\Contract::HEAD_OFFICE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('head_office', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.contract.fields.contract_duration') }}</label>
                <select class="form-control {{ $errors->has('contract_duration') ? 'is-invalid' : '' }}" name="contract_duration" id="contract_duration" required>
                    ...
                    @foreach(App\Contract::CONTRACT_DURATION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('contract_duration', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.contract.fields.contract_time') }}</label>
                <select class="form-control {{ $errors->has('contract_time') ? 'is-invalid' : '' }}" name="contract_time" id="contract_time" required>
                    ...
                    @foreach(App\Contract::CONTRACT_TIME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('contract_time', 'Full time') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.contract.fields.area_type') }}</label>
                <select class="form-control {{ $errors->has('area_type') ? 'is-invalid' : '' }}" name="area_type" id="area_type" required>
                    ...
                    @foreach(App\Contract::AREA_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('area_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('termination_code') ? 'is-invalid' : '' }}" name="termination_code" id="termination_code">
                    ...
                    @foreach(App\Contract::TERMINATION_CODE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('termination_code', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calculation_lps') ? 'is-invalid' : '' }}" type="number" name="calculation_lps" id="calculation_lps" value="{{ old('calculation_lps', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('ccnl') ? 'is-invalid' : '' }}" name="ccnl" id="ccnl">
                    ...
                    @foreach(App\Contract::CCNL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('ccnl', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('ccnl'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('clb_category') ? 'is-invalid' : '' }}" name="clb_category" id="clb_category">
                    ...
                    @foreach(App\Contract::CLB_CATEGORY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('clb_category', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('clb_level') ? 'is-invalid' : '' }}" name="clb_level" id="clb_level">
                    ...
                    @foreach(App\Contract::CLB_LEVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('clb_level', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('us_category') ? 'is-invalid' : '' }}" name="us_category" id="us_category">
                    ...
                    @foreach(App\Contract::US_CATEGORY_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('us_category', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_trial_period_date') ? 'is-invalid' : '' }}" type="text" name="end_trial_period_date" id="end_trial_period_date" value="{{ old('end_trial_period_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weekly_working_hours') ? 'is-invalid' : '' }}" type="number" name="weekly_working_hours" id="weekly_working_hours" value="{{ old('weekly_working_hours', '40') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('report_resource_code') ? 'is-invalid' : '' }}" name="report_resource_code_id" id="report_resource_code_id">
                    @foreach($report_resource_codes as $id => $report_resource_code)
                        <option value="{{ $id }}" {{ old('report_resource_code_id') == $id ? 'selected' : '' }}>{{ $report_resource_code }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hr_canteen_charge') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="hr_canteen_charge" id="hr_canteen_charge" value="1" required {{ old('hr_canteen_charge', 0) == 1 ? 'checked' : '' }}>
                    <label class="required form-check-label" for="hr_canteen_charge">{{ trans('cruds.contract.fields.hr_canteen_charge') }}</label>
                </div>
