...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pmp.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pmps.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pmp_year') ? 'is-invalid' : '' }}" type="number" name="pmp_year" id="pmp_year" value="{{ old('pmp_year', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('current_grade') ? 'is-invalid' : '' }}" name="current_grade_id" id="current_grade_id" required>
                    @foreach($current_grades as $id => $current_grade)
                        <option value="{{ $id }}" {{ old('current_grade_id') == $id ? 'selected' : '' }}>{{ $current_grade }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('expected_grade') ? 'is-invalid' : '' }}" name="expected_grade_id" id="expected_grade_id" required>
                    @foreach($expected_grades as $id => $expected_grade)
                        <option value="{{ $id }}" {{ old('expected_grade_id') == $id ? 'selected' : '' }}>{{ $expected_grade }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('objective_value') ? 'is-invalid' : '' }}" type="number" name="objective_value" id="objective_value" value="{{ old('objective_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('objective_mid_review_date') ? 'is-invalid' : '' }}" type="text" name="objective_mid_review_date" id="objective_mid_review_date" value="{{ old('objective_mid_review_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('objective_end_eval_date') ? 'is-invalid' : '' }}" type="text" name="objective_end_eval_date" id="objective_end_eval_date" value="{{ old('objective_end_eval_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('overall_mid_year_evaluation') ? 'is-invalid' : '' }}" type="number" name="overall_mid_year_evaluation" id="overall_mid_year_evaluation" value="{{ old('overall_mid_year_evaluation', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('overall_end_year_evaluation') ? 'is-invalid' : '' }}" type="number" name="overall_end_year_evaluation" id="overall_end_year_evaluation" value="{{ old('overall_end_year_evaluation', '') }}" step="0.01">
