...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.jobExperience.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.job-experiences.update", [$jobExperience->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('resource_code') ? 'is-invalid' : '' }}" name="resource_code_id" id="resource_code_id" required>
                    @foreach($resource_codes as $id => $resource_code)
                        <option value="{{ $id }}" {{ ($jobExperience->resource_code ? $jobExperience->resource_code->id : old('resource_code_id')) == $id ? 'selected' : '' }}>{{ $resource_code }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_number') ? 'is-invalid' : '' }}" type="number" name="order_number" id="order_number" value="{{ old('order_number', $jobExperience->order_number) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $jobExperience->company_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('company_role') ? 'is-invalid' : '' }}" type="text" name="company_role" id="company_role" value="{{ old('company_role', $jobExperience->company_role) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('job_start_date') ? 'is-invalid' : '' }}" type="text" name="job_start_date" id="job_start_date" value="{{ old('job_start_date', $jobExperience->job_start_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('job_end_date') ? 'is-invalid' : '' }}" type="text" name="job_end_date" id="job_end_date" value="{{ old('job_end_date', $jobExperience->job_end_date) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('job_description') ? 'is-invalid' : '' }}" name="job_description" id="job_description">{!! old('job_description', $jobExperience->job_description) !!}</textarea>
